...
<nav class="navbar is-link" style="background-color:#52c234">
  <div class="navbar-brand">
    <a class="navbar-item" style="background-color:#52c234"href="#" class="has-text-weight-bold">
  ...
  <div id="navbarExampleTransparentExample" class="navbar-menu" style="margin:20px;">
    ...
    <section class="hero is-white is-fullheight">
        <div class="hero-body">
          <div class="container" style="background-color:#52c234"> 
